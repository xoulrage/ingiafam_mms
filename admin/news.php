...
<?php include('page-header.php'); ?>
  ...
  $(document).ready(function () {
    ...
    $('#btn_add').click(function(){
      ...
      window.location.href = 'news-add.php';
      return false;
    ...
    <div id="content_left">
      <div id="content_title">
        <span class="text_title_content">NEWS</span>
      </div>
    ...
    <div id="content_right">
      ...
      <div id="content">
        Click to add a new news article:
        <br /><br />
        <input type="button" id="btn_add" value="ADD NEW NEWS" class="button_blue">
